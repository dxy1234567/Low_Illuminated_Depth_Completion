...
parser.add_argument('--src_dir', default="/data/gml/20241025/gml_2024-10-25-15-59-06/_camera_infra1_image_rect_raw/")
parser.add_argument('--dst_to_dir', default='/data/gml_to_DC/')
